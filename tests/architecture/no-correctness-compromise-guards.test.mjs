...
const GUARDED_MODULES = [
  ...
  'src/domain/warehouseDefaults/warehouseTopologyRepair.ts',
  'src/domain/warehouseDefaults/warehouseDefaultLocationRepair.ts',
  'src/domain/warehouseDefaults/warehouseDefaultsValidation.ts',
