...
- [x] Each QC workflow has an explicitly stated invariant set, cross-referenced against `docs/inventory/domain-invariants.md`.
...
5. **Preserve invariants.** All domain invariants defined in `docs/inventory/domain-invariants.md` must hold before and after every change.
