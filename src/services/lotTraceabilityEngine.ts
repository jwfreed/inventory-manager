...
async function appendTraceabilityLinksWithClient(
  client: PoolClient,
  tenantId: string,
  params: {
    executionId: string;
...
export async function appendTraceabilityLinksInTx(
  client: PoolClient,
  tenantId: string,
  params: {
    executionId: string;
  ...
  return appendTraceabilityLinksWithClient(client, tenantId, params);
}
...
export async function appendTraceabilityLinks(
  ...
  return withTransactionRetry(async (client) => appendTraceabilityLinksWithClient(client, tenantId, params));
}
