...
import { executeReturnPosting } from './returnPostingOrchestrator';
...
export async function postReturnReceipt(
  ...
  return executeReturnPosting({
    type: 'receipt',
    tenantId,
    documentId: id,
    idempotencyKey: normalizedIdempotencyKey,
    fetchAggregateView: getReturnReceipt
  });
}
...
export async function postReturnDisposition(
  ...
  return executeReturnPosting({
    ...
    documentId: id,
    idempotencyKey: normalizedIdempotencyKey,
    fetchAggregateView: getReturnDisposition
  });
}
